...
class Example:
    def __init__(self, stage_path="depictions/quadruped.usd", num_envs=1):
        articulation_builder = wp.sim.ModelBuilder()
        wp.sim.parse_urdf(
            os.path.join(warp.examples.get_asset_directory(), "quadruped.urdf"), # original here: os.path.join(warp.examples.get_asset_directory(), "quadruped.urdf")
